...
class NeighborSet(object):
  ...
  def error_messeage_of_moor(self, number_of_observed_agent, number_of_case):
    print('近傍数' + str(number_of_observed_agent) + 'ケース' +str(number_of_case) + 'の時' + 'error!')
  ...
  def next_step(self, t):
    ...
    elif self.f_neighbor_type == self.VARIABLE_MOOR:
      self.next_step_variable_moor(t)
